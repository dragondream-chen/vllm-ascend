...
V4 Flash DSpark requires vLLM Ascend later than `v0.25.0`. Use the `nightly-releases-v0.25.1rc` image from the [internal image repository](http://cr.rnd.huawei.com/images/vllm-ascend/).
...
=== "A3 series with dspark"
    1. Prefill node
        ...
        vllm serve /root/.cache/modelscope/hub/models/vllm-ascend/DeepSeek-V4-Flash-DSpark-w8a8 \
            --host 0.0.0.0 \
            --port $2 \
            --data-parallel-size $3 \
            --data-parallel-rank $4 \
...
| GPQA | 0.25.0 | accuracy | gen | 90.4 | A3 1P1D DSpark w8a8 |
| SWE Multilingual | 0.25.0 | accuracy | gen | 68.33 | A3 1P1D DSpark w8a8 |
