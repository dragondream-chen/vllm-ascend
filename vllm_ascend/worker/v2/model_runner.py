...
from vllm_ascend.utils import enable_dsa_cp, enable_sp, set_potential_max_tokens
...
class NPUModelRunner(GPUModelRunner):
    ...
    def initialize_kv_cache(self, kv_cache_config: KVCacheConfig) -> None:
        with graph_manager_wrapper(self):
            ...
            uses_dsa_backend = any(
                attn_group.backend is AscendDSABackend
    ...
    def _prepare_dsa_full_graph_padding_inputs(
        ...
        *,
        ...
        padding_query_lens_np = np.diff(
            query_start_loc_np[num_reqs : num_reqs_padded + 1]
        ...
        for query_len in padding_query_lens_np:
            ...
            padding_positions_np[offset : offset + query_len_int] = np.arange(
                query_len_int, dtype=np.int64
            )
