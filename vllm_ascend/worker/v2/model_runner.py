...
class NPUModelRunner(GPUModelRunner):
    ...
    def prepare_inputs(
        ...
        # Full graphs use padded request metadata. Keep the device tensors in
        # lockstep with their CPU counterparts so attention builders (notably
        # DSA) can safely consume the padded decode entries during replay.
        # prepare_pos_seq_lens clears the unused device seq_lens entries.
